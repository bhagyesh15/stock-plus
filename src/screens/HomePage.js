            ...
            <div className="container bg-white" style={{
                ...
                <div>
                    <div className="d-flex align-items-center justify-content-center" style={{height:`100px`}}>
                        <h1 className="display-3 font-center">Build up your financial game with</h1>
                    </div>
                    <div className="d-flex align-items-center justify-content-center mb-5" style={{height:`100px`}}>
                        <p className="mb-0 font-weight-bold" style={{fontSize:`5rem`, display:`block`}}>
                            Stock
