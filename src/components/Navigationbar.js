                ...
                <div className="container">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Form inline>
                            ...
                            <Nav>
                                <a className="nav-link" href="https://github.com/bhagyesh15/stock-plus" target="_blank" rel="noopener noreferrer" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
